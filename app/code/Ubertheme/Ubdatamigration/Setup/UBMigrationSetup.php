...
{
    public static $mappingTableKeyNames = [
        '2', '3', '3_attribute', '3_attribute_option',
        '4', '5', '5_product_option', '5_product_download',
        ...
        '8_rating', '8_subscriber', '8_downloadable_link_purchased', '8_cms'
    ];
    ...
    public static function createTables($installer)
    {
         ...
         */
        foreach (self::$mappingTableKeyNames as $tableKeyName) {
    ...
    public static function addFieldToMappingTable($installer, $tableSuffix, $fieldName, $fieldSettings = [])
    {
        $tableName = "ub_migrate_map_step_{$tableSuffix}";
        if ($installer->getConnection()->isTableExists($tableName)) {
            $installer->getConnection()->addColumn($tableName, $fieldName, $fieldSettings);
        }
